...
import AsyncStorage from "@react-native-async-storage/async-storage"; // Replace MMKV with AsyncStorage

import { clear } from "@/utils/storage"; // Update storage utility to use AsyncStorage
...
const reactotron = Reactotron.configure({
  ...
  .setAsyncStorageHandler(AsyncStorage) // Set AsyncStorage as the storage handler
  .use(
    mst({
